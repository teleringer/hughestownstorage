    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Storage Unit Size Comparison</h2>
          <p className="text-xl text-gray-600">Compare different storage unit sizes to find what works best for you</p>
        </div>
            ...
            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-2xl font-bold text-teal-600">{option.size}</h3>
                  <span className="text-lg font-semibold text-gray-700">{option.sqft}</span>
                </div>
                <p className="text-gray-600 mb-4 font-medium">{option.description}</p>
                <div className="mb-4">
                  <div className="text-center">
                    <div className="text-sm text-gray-600">Monthly Rental</div>
                    <div className="text-lg font-bold text-gray-900">Cash: {option.cashPrice}</div>
                    <div className="text-sm text-gray-600">Card: {option.cardPrice}</div>
                  </div>
                </div>
                <div>
                  ...
                  <ul className="space-y-1">
                    {option.items.map((item, itemIndex) => (
                      <li key={itemIndex} className="text-gray-600 flex items-center">
                        <i className="ri-check-line text-teal-600 mr-2 w-4 h-4 flex items-center justify-center"></i>
                        {item}
                      </li>
                    ))}
                  </ul>
                ...
                <a 
                  ...
                  className="w-full mt-6 bg-teal-600 text-white py-3 rounded-lg font-semibold hover:bg-teal-700 whitespace-nowrap cursor-pointer block text-center"
                >
                  Rent Now
                </a>
              </div>
