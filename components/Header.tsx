  ...
  return (
    <>
      <header className="w-full bg-gradient-to-b from-gray-200 to-gray-50 shadow-sm fixed top-0 z-50">
        ...
        <div
          className={`py-2 text-sm hidden md:block transition-all duration-500 ease-in-out overflow-hidden ${
        ...
        <div
          className={`hidden md:block w-full h-px bg-black transition-all duration-500 ease-in-out ${
        ...
        <div
          className={`text-center md:hidden transition-all duration-500 ease-in-out overflow-hidden ${
        ...
        <div className="py-1 md:py-4">
          <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <div className="flex md:hidden items-center justify-between w-full py-1">
              ...
              <button onClick={handleMobileMenuToggle} className="flex items-center justify-center w-10 h-10" style={{ width: '15%' }}>
            ...
            <nav className="hidden md:flex items-center space-x-2">
              ...
              <a
                ...
                className="px-6 py-2 text-gray-700 hover:text-red-600 whitespace-nowrap cursor-pointer font-bold"
              >
                SIGN IN
              </a>
              <a
                ...
                {isDropdownOpen && (
                  <div className="absolute top-full right-0 bg-blue-600 shadow-lg rounded-b-lg z-50 min-w-[200px]">
                    ...
                    <Link
                      ...
                      className="block px-4 py-3 text-white hover:bg-blue-700 border-b border-blue-500 cursor-pointer"
                    >
              ...
              <div className="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                ...
                <div>
                  ...
                  >
                    MORE INFO
                    <i
                      className={`ri-arrow-down-s-line text-white transform transition-transform ${isMoreInfoOpen ? 'rotate-180' : ''}`}
                    ></i>
                  </button>
